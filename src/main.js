import './style.css';
const PROFILE = {"day":"Day076","title":"Friend Intro Card","display_name_ja":"初対面ひと言札","one_sentence":"初対面の相手に話す入口を、短い札にするツール","purpose_line_ja":"初対面の最初の一言を決めるツールです。","use_case_line_ja":"会食直前に話し始めが不安な時に使います。","how_it_works_line_ja":"相手情報を入れると、入口札が出ます。","core_action":"flow_pick","family":"intro_hint_deck","mechanic":"flow_pick","input_style":"people_nodes","output_style":"request_card","output_label":"この頼み方なら伝わります","audience_promise":"話し始めの不安を、持てる短い札にできる。","publish_hook":"相手の文脈と避けたい話題を入れると、最初の一言と次の橋渡しだけが札になる。","engine":"brief_driven","interaction_archetype":"flow_pick","page_archetype":"network_stage","ui_variant":"dinner","intro_variant":"dinner_pick","interaction_model":"toggle_ingredients_to_survivor_meals","primary_layout":"ingredient_filter_bar_with_meal_cards","result_presentation_style":"remaining_meal_cards","palette_motif":"キッチンアプリコット","main_cta":"冷蔵庫の残りで試す","input_panel_title":"今ある食材を選ぶ","sample_panel_title":"冷蔵庫の残りで試す","guide_panel_title":"献立の見どころ","hero_panel_label":"今夜の候補","output_shape":"network_stage","state_model":"flow_pick_state","core_loop":"people_nodes -> flow_pick -> request_card","component_pack":"network_stage+request_card","scaffold_id":"brief_canvas","single_shot_text_generator":false};
