import './style.css';
const PROFILE = {"day":"Day076","title":"Friend Intro Card","display_name_ja":"初対面ひと言札","one_sentence":"初対面の相手に話す入口を、短い札にするツール","purpose_line_ja":"初対面の最初の一言を決めるツールです。","use_case_line_ja":"会食直前に話し始めが不安な時に使います。","how_it_works_line_ja":"相手情報を入れると、入口札が出ます。","core_action":"flow_pick","family":"intro_hint_deck","mechanic":"flow_pick","input_style":"people_nodes","output_style":"request_card","output_label":"この頼み方なら伝わります","audience_promise":"話し始めの不安を、持てる短い札にできる。","publish_hook":"相手の文脈と避けたい話題を入れると、最初の一言と次の橋渡しだけが札になる。","engine":"brief_driven","interaction_archetype":"flow_pick","page_archetype":"network_stage","ui_variant":"intro","intro_variant":"first_meeting_cards","interaction_model":"editable_people_context_to_opening_cards","primary_layout":"person_context_editor_with_phrase_cards","result_presentation_style":"opening_line_and_bridge_cards","palette_motif":"初対面ブリッジブルー","main_cta":"初対面の前で試す","input_panel_title":"相手情報と避けたい話題を足す","sample_panel_title":"初対面の前で試す","guide_panel_title":"最初の一言の見どころ","hero_panel_label":"最初の一言札","output_shape":"network_stage","state_model":"flow_pick_state","core_loop":"people_nodes -> flow_pick -> request_card","component_pack":"network_stage+request_card","scaffold_id":"brief_canvas","single_shot_text_generator":false};
